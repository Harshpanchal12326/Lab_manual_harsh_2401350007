...
class Student extends Person {
    ...
    public Student(String name, String email, int rollNo, String course, double marks) {
        super(name, email); // Call the constructor of the Parent (Person) class
        this.rollNo = rollNo;
        this.course = course;
        this.marks = marks;
        calculateGrade();
    ...
    // Setter to update marks and recalculate grade
    public void setMarks(double marks) {
        this.marks = marks;
        calculateGrade();
    }

    // METHOD OVERRIDING: Implementing the abstract method from Person
    @Override
    void displayInfo() {
        System.out.println("\n--- Student Profile ---");
...
// Handles the storage and operations.
class StudentManager implements RecordActions {
    ...
    public void deleteStudent(int rollNo) {
        // removeIf is a shortcut to remove an item if the condition matches
    ...
    // This version finds a student by Name instead of Roll No
