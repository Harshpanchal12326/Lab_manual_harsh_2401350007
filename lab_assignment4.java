...
class Student {
    ...
    // Helper method to format data for saving to file (CSV format)
...
class StudentManager {
    ...
    // --- File Handling: Load Data on Start ---
    ...
    // --- File Attributes using File Class ---
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    manager.saveToFile(); // Save data before exiting
